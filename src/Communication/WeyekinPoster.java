...
//            httpPost.setURI(new URI("http://128.197.164.27/pigeon.php"));
    ...
    /**
     * Aspect ratio ([0.0, 2.0]) Using major, minor, major, major
     *
     * @param aratio
     */
    ...
    /**
     * Background color: If you assign #xyzwuv to the bgcolor variable in
     * weyekin, then you can control the background color on pigeon images.
    ...
    public static boolean isShouldILaunchBrowserPage() {
        return _shouldILaunchBrowserPage;
    }

    public static void setShouldILaunchBrowserPage(boolean _shouldILaunchBrowserPage) {
        WeyekinPoster._shouldILaunchBrowserPage = _shouldILaunchBrowserPage;
    }
}
